...
# In[15]:
    ...
    Ef_addS_low=chemical_pot_2(mu_S0_i,470,1700,500,8,E1,E0,-1,1,w1,w0,wS8,mat=False)
    Ef_addS_high=chemical_pot_2(mu_S0_f,470,1700,500,8,E1,E0,-1,1,w1,w0,wS8,mat=False)
    Ef_VS_low=chemical_pot_2(mu_S0_i,470,1700,500,8,E2,E0,1,1,w2,w0,wS8,mat=False)
    Ef_VS_high=chemical_pot_2(mu_S0_f,470,1700,500,8,E2,E0,1,1,w2,w0,wS8,mat=False)
    Ef_VS2_low=chemical_pot_2(mu_S0_i,470,1700,500,8,E3,E0,1,2,w3,w0,wS8,mat=False)
    Ef_VS2_high=chemical_pot_2(mu_S0_f,470,1700,500,8,E3,E0,1,2,w3,w0,wS8,mat=False)
    Ef_VS22_low=chemical_pot_2(mu_S0_i,470,1700,500,8,E4,E0,1,2,w4,w0,wS8,mat=False)
    Ef_VS22_high=chemical_pot_2(mu_S0_f,470,1700,500,8,E4,E0,1,2,w4,w0,wS8,mat=False)
    Ef_VMo_low=chemical_pot_2(mu_S0_f,470,1700,500,8,E5,E0,1,1,w5,w0,wS8,mat=True)
    Ef_VMo_high=chemical_pot_2(mu_S0_i,470,1700,500,8,E5,E0,1,1,w5,w0,wS8,mat=True)
